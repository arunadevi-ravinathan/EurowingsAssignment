...
public abstract class Reporter extends DriverInstance {
	...
	public String testcaseName, testDescription, category, dataFileName, dataFileType, excelFileName;
	...
	public synchronized void startReport() {
		...
		htmlReporter.config().setDocumentTitle("EuroWings");
		htmlReporter.config().setEncoding("utf-8");
		htmlReporter.config().setReportName("EuroWings");
